...
export class RecreateCombinacaoComparacaoEnum1761833415244 implements MigrationInterface {
    name = 'RecreateCombinacaoComparacaoEnum1761833415244'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "comparacao_viagens" ADD "tipo_combinacao" "public"."comparacao_viagens_tipo_combinacao_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_0efb1d39ed772fd02383cb6c7c" ON "comparacao_viagens" ("data_referencia", "status_comparacao") `);
        await queryRunner.query(`ALTER TABLE "comparacao_viagens" DROP COLUMN "tipo_combinacao"`);
